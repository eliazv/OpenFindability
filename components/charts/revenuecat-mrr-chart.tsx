...
export function RevenueCatMrrChart({ data, currency }: { data: TrendPoint[]; currency?: string }) {
  return (
    <ChartContainer config={chartConfig} className="aspect-auto h-[200px] w-full">
      <AreaChart data={data} margin={{ left: 0, right: 0 }}>
        <defs>
          <linearGradient id="fillRevenueCatMrr" x1="0" y1="0" x2="0" y2="1">
        ...
        />
        <Area dataKey="value" type="natural" fill="url(#fillRevenueCatMrr)" stroke="var(--color-value)" />
      </AreaChart>
    </ChartContainer>
  );
}
